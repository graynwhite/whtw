...
<tr>
  <td colspan="4">Event or activity information: This is the bare bones information. Make sure you specify a contact. <br>
    <span class="important">Do <strong>Not</strong> repeat the place, Time and date information</span> in the Event or activity text box (The system will insert it) </td>
</tr>

<tr>
  <td width="191"> Event or Activity(What appears in WHTW and the peggy Jo Newsletter if press release field is left blank):</TD>
  <td colspan ="3" width="696" ><textarea class="markItUp" wrap rows="3" name="activity" cols="80"
...
<span class="important">Do <strong>Not</strong> repeat the place, Time and date information i</span>n the Media text box (The system will insert it) </TD>
</tr>
</tr>
<tr>
  <td width="191">Press Release Data (If filled in,what appears in the Peggy Jo Studio Newsletter) </td>
  <td colspan ="3" width="696" ><textarea class="markItUp" wrap name="media" cols="80" rows="12" 
