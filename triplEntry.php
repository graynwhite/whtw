...
$place = $_POST['site'] == 'Other' ? htmlspecialchars($_POST['other_site_text']) : $ire->getSiteInfo("theaterVenues.xml",$_POST['site']);
$contact = $ire->getContactInfo("artFestivalOrgs.xml",trim($event_org));
