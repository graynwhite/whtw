...
$use_profile = isset($_GET['use_profile']) ? $_GET['use_profile'] : 'false';
...
//$sourceg = $_SERVER['REMOTE_ADDR'];
   ...
   $allow_images = $pub->get_allow_images($select_org);
    }
...
{
document.setElementById("jsEnabled").style.visibility = 'visible';
document.setElementById("jsDisabled").style.visibility = 'hidden';
...
<div id="jsDisabled" style="visibility:hidden">
...
<input type="hidden" name="allow_images" id="allow_images" value="<?=$allow_images?>" />
<?
...
<TD width="294" height="22"><input name="emailid" id="emailid" type="text" class="formInputText"  size="60" /></td>
<TD width="195" height="22" >Password</TD>
<TD width="195" height="22">	

<input name="yourpswd" type="password" class="formInputText" size="20"></TR>
<TR >
...
<TD width="195" height="23"><input name="event_title" type="text" class="formInputText" id="event_title" size="50" maxlength="50"></td>
</TR>
<TR>
...
Post</label></td>
    ...
    <br></td>
  <TD height="67"  ColSpan = "2" class="formInputText"><label for="label">Final End Date</label>
    <input name="finalEndDate" type="text" class="formInputText" id="label" size="20" maxlength="24" /></TD>
</TR>
<?php
	}
?> 
...
<TR><TD width="191" height="68">Place :</TD>
  ...
  Place Name 
    <input name="place_name" type="text" class="formInputText" id="place_name" onDblClick="clearPlace()"onKeyUp="typeAhead(document.getElementById(this.id))"  size="40" title="This is the ultimate destination such as Boyne Mountain or Emagine theater not a parking lot location or restaurant prior to performance" >
    <?php
	if($operator=='admin')
	{
	?>
...
<TR>
  <TD colspan="4">Event or activity information: This is the bare bones information. Make sure you specify a contact. <br>
    <span class="important">Do <strong>Not</strong> repeat the place, Time and date information in the Event or activity text box (The system will insert it)</span> </TD>
</TR>

<TR>
  <td width="191"> Event or Activity(What appears in WHTW and the peggy Jo Newsletter if press release field is left blank):</td>
  <td colspan ="3" width="696" ><textarea rows="3" name="activity" wrap  cols="80"
  ...
  Contact: 
  <input name="activity_contact" type="text" class="formInputText"  id= "activity_contact" size="40"></td>
</tr>
<tr>
...
<span class="important">Do <strong>Not</strong> repeat the place, Time and date information in the Media text box (The system will insert it)</span> </td>
</tr>

<tr>
  <td width="191">Press Release Data (If filled in,what appears in the Peggy Jo Studio Newsletter) </td>
  <td colspan ="3" width="696" ><textarea name="media" cols="80" rows="12" wrap class="markItUp"
...
<td>Media Text  max 900  
  <input type="text" name="count_media" value="0" size="4" readonly></td>
<TR><td width="191" height="22">Hyperlink</td><TD width="294" height="22">
  <input name="reference" type="text" class="formInputText" size="40"></TD>
<TD width="195" height="22">Event Code</TD>
<TD width="195" height="22"><input name="eventCode" type="text" id="eventCode" /></td>
</TR>
<TR><td width="191" height="22">Price Members :</td><TD width="294" height="22"><input name="Price_Member" type="text" class="formInputText" size="20" maxlength="20" /></TD>
<TD width="195" height="22">Price Guests</TD><TD width="195" height="22"><INPUT NAME="Non_Member_Price" TYPE="text" class="formInputText" SIZE="20" MAXLENGTH="20" ></td>
</TR>
<TR>
