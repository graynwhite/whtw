...
/** @package
        ...
        event_input_place.php
        
        Copyright(c) Gray and White Computing 2002
        
        Author: FRANK J CAULEY
        Created: FJC 12/28/2003 8:09:49 PM
	Last change: FJC 12/30/2003 6:09:45 PM
*/
...
function remove_quotes(oldstr,newstr){
...
//Fill in place field
function fillplace(place_code_text){
    alert("here we are");
   // var pcode = form.place_code.value;
    alert(place_code_text);
    alert("pcode");
   form.newplace.value="Place information";
  // form.refresh;
}
//-->
...
<TR><TD width="191" height="68">Place Code </TD>
  <TD COLSPAN="3" width="696" height="68">
<select size="1" name="place_code" >
<?php while ($place_row=mysql_fetch_array($place_result)){
    ?>
 <OPTION value"<?=$place_row['Location']?>"><?=$place_row['Place_code']?>
 <?php
}
?>

</select>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="New_place" value="false" onClick="fillplace(<?=$place_row['Location']?>)"> New Place
<input type="radio" name="New_place" value="true">
&nbsp;&nbsp;&nbsp;&nbsp;<input type=text size=20 name="newplace">
</TD>
</TR>
