...
<script type="text/javascript" src="../datepicker/jquery.ui.datepicker.mobile.js"></script>
  <link rel="stylesheet" type="text/css" href="../datepicker/jquery.ui.datepicker.mobile.css" />  
...
$( "#datepickerRes").datepicker("option", "dateFormat","yy-mm-dd");
$( "#datepickerTo").datepicker("option", "dateFormat","yy-mm-dd");
$( "#timeStart").timepicker({timeFormat:"h:mm p", startTime: new Date(0,0,0,19,0,0),
interval:15 });
$( "#timeEnd").timepicker({timeFormat:"h:mm p", startTime: new Date(0,0,0,19,0,0),
interval:15 });
  ...
  <table align = "left" border= "1" width = "100%" style="border-collapse: collapse" bordercolor="#111111" cellpadding="0" cellspacing="0">
    <tr >
      ...
      <td>
          ...
          <span class="explanation">No</span>      </td></tr>
    </tr>
    <tr >
    ...
    <tr >
      ...
      <td><input name="Orgname" type="text" id="Orgname"  size="40" maxlength="80" />
    ...
    <tr>
      ...
      <td><input name="Email" id="Email" type ="text"  size="40" maxlength="45" />
          <span class="Required">*</span> </td>
    </tr>
	...
	<tr>
      ...
      <td><input name="EventTitle" type="text" id="EventTitle" size="50" maxlength="100" /></td>
    </tr>
    <tr>
	 ...
	 <input type="text" id="datepickerFrom"  name="datestart" />    </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
          <input type="text" id="timeStart" class="time">
    ...
    <tr>
      ...
      <td>
            ...
            <input type="text" id="timeEnd" class="time" name="to_time"/>
      </td>
    </tr>
    <tr>
...
<div data_role=footer><h1>Event Input Mail</div>
</div><!-- End of Page -->
<!-- ========================== -->
</body>
</html>