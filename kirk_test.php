...
/** @package 
        ...
        Created: FJC 10/23/2004 8:58:42 AM
	Last change: FJC 10/28/2004 4:40:49 PM
*/
?>
...
<TITLE>Kirk&nbsp; event input screen</TITLE>
...
<BODY>
<H1>&nbsp;Post Kirk Singles  Event Information</H1>

<Form onSubmit="return check_page(this)" action ="http://graypluswhite.com/whtw/club_entry.php" method="Get" name="FrontPage_Form1">
...
<TD width="294" height="23">Kirk Singles
<input type="hidden" name = "Org" Value = "kirk"></td>
 </TR>
