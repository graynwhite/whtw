...
<title>Michigan Single Professionals input form</title>
...
$activityRadio = $ire->bldActRadio("mspActivities.xml",80);
echo  $activityRadio;
?>
<p>Other event description:
<textarea rows="3" name="other_event_text" cols="80"></textarea></p>
<?PHP
$siteRadio = $ire->bldVenueRadio("mspVenues.xml",80);
echo  $siteRadio;
?>
<p>Other site description:
