...
//excerpted from replaceWordCharacters.js 
 // smart single quotes and apostrophe
    ...
    testString = testString.replace(/[\u201C|\u201D|\u201E]/g, "\"");
    // ellipsis
    testString = testString.replace(/\u2026/g, "---"); //changed to dashes for constant contact original  three dots
    // dashes
    testString = testString.replace(/[\u2013|\u2014]/g, "-");
    // circumflex
...
function insertMaggie(obj)
{ var work=obj.value;
alert("insert maggie?");
var imageNumber=Math.floor((Math.random() * 18) + 2);

var work2 ="<img src=\"http://www.peggyjostudio.net/E/maggie/maggieMcCabe" + imagNumber + ".jpg \" align=\"left\" height=\"180\" alt=\"Maggie McCabe Photo\" hspace=\"5\">";
obj.value=work2 + work;
...
echo("Activity<br> <textarea class=\"markItUp\" wrap name = \"activity\" id=\"activity\" cols=\"64\" rows=\"4\" >$row[Activity]</textarea><br>\n");
...
echo("<br /><hr />");
echo("Media Text<br> <textarea wrap class=\"markItUp\" name = \"media\" id=\"media\" cols=\"85\" rows=\"20\" >$row[media]</textarea><br>\n");

// echo("<input type=\"button\" id=\"editmed\" value=\"Edit Media\" onclick=\"regxMicrosoft(media)\">");
echo("<input type=\"button\" id=\"editpar\" value=\"Edit Paragraph\" onclick=\"regxMicrosoft(media)\">");
echo("<input type=\"button\" id=\"insertMaggie\" value=\"Insert Maggie\" onclick=\"insertMaggie(media)\">");
