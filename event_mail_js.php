...
function check_page(form){
	...
	console.log("about to test name input");
	...
	console.log("about to test email input");
	if (!re.test(form.Email.value)) {
		alert("Invalid email Address.")
		form.Email.focus()
		return false
	}
	console.log("about to test from date input");
	console.log("date length " + form.From_date.value.length);
	console.trace();
	alert('from date');
	if (form.From_mm.value.length < 1){
		...
		console.log("about to test second from date input");
		var fromdate= form.From_mm.value + '' + form.from_dd
		...
		console.log("about to test reserve by input");
		...
		console.log("about to test to-date input");
		...
		console.log("about to test place-name input");
		...
		console.log("about to test event title input");
...
<br /> 
  <img src="graynwhitebannereventMaint.jpg" width="468" height="60" /></h1>
...
?>
<form  action="../../emailControl/maillToWebmaster.php?org=eventinput" method="post" name='formInput' id='formInput'  onsubmit="return check_page(this)" >
  <p>
  ...
  <table align = "left" border= "1" width = "100%" style="border-collapse: collapse" bordercolor="#111111" cellpadding="0" cellspacing="0">
    ...
    <tr >
      ...
      <td><span class="explanation">
        ...
        (Send an email to webmaster@graynwhite.com to explain change) <br />
       
        <input type="radio" name="radioEntryType" value="delete" />
          Delete
 (send an email to webmaster@graynwhite.com)  </span></td>
    </tr>
    <tr >
